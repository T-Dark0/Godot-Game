...
{
#nullable disable
    [Export] private Texture _trajectoryReachable;
    [Export] private Texture _trajectoryBlocker;
    [Export] private Texture _trajectoryUnreachable;
#nullable enable

    [Export] public uint WalkSpeed { get; private set; }
    [Export] public uint RunSpeed { get; private set; }
    [Export] public uint CameraWalkSpeed { get; private set; }
    [Export] public uint CameraRunSpeed { get; private set; }
    [Export] public int VisionRadius { get; private set; }
